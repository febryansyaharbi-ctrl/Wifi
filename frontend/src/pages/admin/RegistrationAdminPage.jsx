            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="flex gap-2 flex-wrap lg:justify-end">
                {(a.status === "PAYMENT_REPORTED" || a.status === "PENDING_PAYMENT") && (
                  <>
                    <button disabled={a.status !== "PAYMENT_REPORTED" || busy === a.id+"verify"} onClick={() => action(a.id,"verify")} title={a.status !== "PAYMENT_REPORTED" ? "Tunggu pendaftar melaporkan pembayaran" : "Setujui pembayaran"} className="inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold text-white bg-emerald-600 disabled:opacity-40">
